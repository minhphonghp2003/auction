          ...
          <div class="row tm-edit-product-row">
            <div class="col-xl-6 col-lg-6 col-md-12">
              <div class="form-group mb-3">
                ...
                <input type="text" v-model="sku" class="form-control validate" required />
                <label for="name">Product Name </label>
                <input type="text" v-model="name" class="form-control validate" required />
              </div>
              <div class="form-group mb-3">
                <label for="description">Description <span style="color:red">(Be careful, you will not be able to update your product when submitted)</span></label>
                <textarea
                v-model="description"
              ...
              <div class="form-group mb-3">
                ...
                <select v-model="category" class="custom-select tm-select-accounts" id="category">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
              ...
              <div class="form-group mb-3 col-xs-12 col-sm-6">
                ...
                <input v-model="condition" type="text" class="form-control validate" required />
